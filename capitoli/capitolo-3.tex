...
Per lo sviluppo su questo tipo di piattaforma è necessario l'uso degli strumenti, quali emulatori e ambienti di sviluppo, illustrati nella sezione relativa alle "\textit{Tecnologie e strumenti a supporto di processi e servizi}"[\ref{Ambienti di sviluppo ed emulatori}].\\
