...
%	\newpage
	...
	I linguaggi di programmazione utilizzati dagli sviluppatori facenti parte della divisione dove sono stato inserito, ovvero la "793 - Servizi Finanziari e Assicurazioni", sono molteplici, essendo che quest'ultima lavora su vari progetti in distente sedi italiane. Elencherò quindi solo le tecnologie utilizzate all'interno del progetto su cui lavora il team di cui ho fatto parte durante lo stage.
...
%		\centering
%		\includegraphics[width=0.25\textwidth]{immagini/HTML5_CSS_JavaScript}
