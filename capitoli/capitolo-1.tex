...
L'azienda presso la quale ho svolto il mio stage è Sopra Steria Group S.p.A, una delle più complete offerte di servizi end to end presenti oggi sul mercato.
...
Essa spazia su diversi mercati come Fashion, Banking, Energy, Aeronautica, Settore pubblico, Difesa e Trasporti.\\

Sopra Steria Group è partner di riferimento delle principali aziende ed organizzazioni pubbliche e private proponendo progetti di trasformazione di successo per affrontare al meglio le sfide di business più critiche e complesse, combinando un'alta qualità dei servizi erogati, valore aggiunto e innovazione, Sopra Steria Group permette ai suoi clienti di sfruttare al meglio le Tecnologie dell’Informazione per accrescere performance e competitività.
Sopra Steria Group conta più di 40.000 collaboratori in più di 20 paesi, inoltre vanta un fatturato di 3,7 miliardi di euro nel 2016.

\begin{figure}[H]
	\centering
   	\includegraphics[width=0.2\textwidth]{immagini/dipendenti_paesi_fatturato_mondo}
   	\caption{Informazioni generali di Sopra Steria Group S.p.A. - Fonte: sito internet dell'azienda}
\end{figure}

Nello specifico opera sul territorio italiano con più di 800 risorse distribuite nelle sue sedi di Ariano Irpino (AV), Assago (MI), Asti, Collecchio (PR), Padova e Roma, fatturando nell'anno 2016 circa 56,9 milioni.\\
